...
//                  CGPathMoveToPoint(path, [], originX, 0.0)
//                  CGPathAddLineToPoint(path, [], originX, self.frame.size.height)
                ...
                for index in 1..<self.segments.count {
                    ...
                    path.move(to:  CGPoint(x :originY , y :0.0))
                    path.addLine(to: CGPoint(x: originY , y :self.frame.size.width))
//                  CGPathMoveToPoint(path, [], 0.0, originY)
//                  CGPathAddLineToPoint(path, [], self.frame.size.width, originY)
