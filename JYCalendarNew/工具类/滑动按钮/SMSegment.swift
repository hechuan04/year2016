...
open class SMSegment: SMBasicSegment {
    ...
    func setupUIElements() {
        ...
        //改变颜色的通知
        NotificationCenter.default.addObserver(self, selector: #selector(SMSegment.setBgView(_:)), name: NSNotification.Name(rawValue: "kNotificationForChangeSelectBg"), object:nil);
    ...
    //改变背景颜色
    open func setBgView(_ notification:Notification){
        
        print(notification.userInfo);
        
        let nowUserInfo = notification.userInfo as![String:AnyObject];
        
        self.onSelectionColour = nowUserInfo["bgColor"] as!UIColor
        self.offSelectionTextColour = nowUserInfo["bgColor"] as!UIColor
        
        let nowColor = nowUserInfo["bgColor"] as!UIColor
