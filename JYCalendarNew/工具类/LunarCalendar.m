...
-(void)InitializeValueForComputeSolarTerm:(int )_year :(int)_month :(int)_day
{
    month = _month;
    year  = _year;
    day  = _day;
    
    thisdate = [Tool actionForReturnSelectedDateWithDay:day Year:year month:month];
...
-(NSString *)getWorldHoliday:(int)aMonth day:(int)aDay
{
    ...
    [dict setObject:@" 复活节" forKey:@"0325"];
    [dict setObject:@" 复活节" forKey:@"0326"];
    [dict setObject:@" 复活节" forKey:@"0327"];
    [dict setObject:@" 复活节" forKey:@"0328"];
    [dict setObject:@" 复活节" forKey:@"0329"];
    [dict setObject:@" 复活节" forKey:@"0330"];
    [dict setObject:@" 复活节" forKey:@"0331"];
    [dict setObject:@" 复活节 " forKey:@"0330"];
    [dict setObject:@" 复活节 " forKey:@"0331"];
    [dict setObject:@" 愚人节 复活节" forKey:@"0401"];
    [dict setObject:@" 国际儿童图书日 复活节" forKey:@"0402"];
    [dict setObject:@" 复活节" forKey:@"0403"];
    [dict setObject:@" 复活节" forKey:@"0404"];
    [dict setObject:@" 复活节" forKey:@"0405"];
    [dict setObject:@" 复活节" forKey:@"0406"];
    [dict setObject:@" 卫生日 复活节" forKey:@"0407"];
    [dict setObject:@" 复活节" forKey:@"0408"];
    [dict setObject:@" 复活节" forKey:@"0409"];
    [dict setObject:@" 复活节" forKey:@"0410"];
    [dict setObject:@" 复活节" forKey:@"0411"];
    [dict setObject:@" 复活节" forKey:@"0412"];
    [dict setObject:@" 复活节" forKey:@"0413"];
    [dict setObject:@" 复活节" forKey:@"0414"];
    [dict setObject:@" 复活节" forKey:@"0415"];
    [dict setObject:@" 复活节" forKey:@"0416"];
    [dict setObject:@" 复活节" forKey:@"0417"];
    [dict setObject:@" 复活节" forKey:@"0418"];
    [dict setObject:@" 复活节" forKey:@"0419"];
    [dict setObject:@" 复活节" forKey:@"0420"];
    [dict setObject:@" 复活节" forKey:@"0421"];
    [dict setObject:@" 地球日 世界法律日" forKey:@"0422"];
    [dict setObject:@" 世界图书和版权日" forKey:@"0423"];
    [dict setObject:@" 复活节 世界青年反对殖民主义日" forKey:@"0424"];
    [dict setObject:@" 复活节" forKey:@"0425"];
    [dict setObject:@" 知识产权 复活节" forKey:@"0426"];
    [dict setObject:@" 复活节" forKey:@"0427"];
    [dict setObject:@" 复活节" forKey:@"0428"];
    [dict setObject:@" 复活节" forKey:@"0429"];
    [dict setObject:@" 复活节" forKey:@"0430"];
    ...
    [dict setObject:@" 国际禁毒日" forKey:@"0626"];
    ...
    [dict setObject:@" 教师节 世界预防自杀日" forKey:@"0910"];
...
-(NSString *)getWeekHoliday:(int)aYear month:(int)aMonth day:(int)aDay
{
    ...
    [dict setObject:@" 母亲节" forKey:@"0520"];
    [dict setObject:@" 助残日" forKey:@"0530"];
    [dict setObject:@" 牛奶日" forKey:@"0532"];
    [dict setObject:@" 遗产日" forKey:@"0626"];
    [dict setObject:@" 父亲节" forKey:@"0630"];
    [dict setObject:@" 合作节" forKey:@"0716"];
    [dict setObject:@" 和平日" forKey:@"0932"];
    [dict setObject:@" 国防教育" forKey:@"0936"];
    [dict setObject:@" 儿童日" forKey:@"0940"];
    [dict setObject:@" 海事日" forKey:@"0950"];
